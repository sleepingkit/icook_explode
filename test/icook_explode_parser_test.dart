  ...
  group('Parser', () {
    group('Search content HTML', () {
      test('[SUCCESS CASE] Normal HTML', () async {
        // 因為suggestions 出現過兩個format, 所以有兩個sample
        final List<String> samplesPath = [
          'test/sample_data/search/search_key_success_sample_1.html',
          'test/sample_data/search/search_key_success_sample_2.html'
        ];

        for (var samplePath in samplesPath) {
